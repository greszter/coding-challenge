...
- Create schedule: `/create-schedule`
    ...
    - If a talk title does not have a length (either in minutes or in 'lightning') it will not be included in the final schedule

To build and run the application use `mvn clean install` and then run the application with `mvn spring-boot:run`
